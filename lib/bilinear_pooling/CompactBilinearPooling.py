...
import lib.pytorch_fft.fft.autograd as afft
...
class CompactBilinearPooling(nn.Module):
    ...
    def __init__(self, input_dim1, input_dim2, output_dim,
        ...
        sparse_sketch_matrix1 = Variable(self.generate_sketch_matrix(
        ...
        sparse_sketch_matrix2 = Variable(self.generate_sketch_matrix(
            rand_h_2, rand_s_2, self.output_dim))
        self.register_buffer("sparse_sketch_matrix1", sparse_sketch_matrix1)
        self.register_buffer("sparse_sketch_matrix2", sparse_sketch_matrix2)
...
if __name__ == '__main__':
    ...
    bottom1 = Variable(torch.randn(48, 2048, 7, 7)).cuda()
    bottom2 = Variable(torch.randn(48, 2048, 7, 7)).cuda()

    layer = CompactBilinearPooling(2048, 2048, 16000)
    layer.cuda()
    layer.train()
